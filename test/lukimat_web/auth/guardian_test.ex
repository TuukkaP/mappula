defmodule LukimatWeb.GuardianTest do
  use Lukimat.DataCase

  alias Lukimat.Accounts
  alias LukimatWeb.Guardian

  @user_attrs %{email: "mail@example.org", password: "Pwd123", password_confirmation: "Pwd123", language: "fi", class: "1A", role: "master"}
